...
uint16_t FT6336U::read_touch1_x_ext(void) {
    uint16_t x;
	...
	switch (touch_rotation) {
		...
		break;
		case Rotation_2:
			x = TouchWidth - read_touch1_x(); 
		break;
		case Rotation_3:
			x = TouchHeight - read_touch1_y(); 
		break;
	}
	return x;
}
uint16_t FT6336U::read_touch1_y_ext(void) {
    uint16_t y;
	...
	switch (touch_rotation) {
		...
		break;
		case Rotation_1:
			y = TouchWidth - read_touch1_x();
		break;
		case Rotation_2:
			y = TouchHeight - read_touch1_y();
		break;
		case Rotation_3:
			y = read_touch1_x();
		break;
